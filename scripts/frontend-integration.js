 ...
 * This file demonstrates how to integrate Gateapex with a web frontend
 */

// For React/Vue/Angular applications
export class GateapexClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GateapexClient(provider, contractAddress);
